...
const Header = () => {
    return (
        <div className='w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4'>
            ...
            >
                <Image src={profile_img1} alt="" className='rounded-full w-32' />
            </motion.div>
            ...
            <motion.h3
                ...
                Hi! I'm Nikhil S <Image src={assets.hand_icon} alt='' className='w-6' /></motion.h3>
            <motion.h1
                initial={{ y: -30, opacity: 0 }}
                whileInView={{ y: 0, opacity: 1 }}
                transition={{ duration: 0.8, delay: 0.5 }}
                className='text-3xl sm:text-6xl lg:text-[66px] font-Ovo'>
                Product, Strategy and Business Excellence</motion.h1>
            ...
            <div className='flex flex-col sm:flex-row items-center gap-4 mt-4'>
                <motion.a
                    ...
                    href="#contact"
                    className='px-10 py-3 border border-white rounded-full bg-black text-white flex items-center gap-2'>Contact Me <Image src={assets.right_arrow_white} alt="" className='w-4' /></motion.a>
